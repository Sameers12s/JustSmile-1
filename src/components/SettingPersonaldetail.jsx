      ...
      <div className=" flex flex-col  h-auto w-full justify-between bg-neutrals-800 rounded-lg">
        ...
        <div className="flex flex-row px-3">
          ...
          <div className="basis-3/4">
            <input className=" textarea bg-neutrals-900 rounded-lg px-3 w-full h-3 mt-4" placeholder="GoodBits"></input>
          </div>
        </div>
        <div className="flex flex-row px-3">
          <h1 className=" basis-1/4 pt-3">Bio</h1>
          <div className="basis-3/4 items-end pt-1">
            <textarea className="textarea bg-neutrals-900 rounded-lg w-full h-20]" placeholder="My profile BIO&#10;Here I put details about Myself"></textarea>
          </div></div>

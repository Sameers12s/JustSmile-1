const DangerZone = () => {
  return (
    <div className="flex h-full w-full items-center justify-center overflow-hidden">
      <div className="flex h-full w-full justify-center items-center rounded-lg" style={{
        ...
        <div className="flex w-full justify-center items-center bg-neutrals-900 rounded-lg m-6">
          <div className="flex flex-col justify-center items-center py-4">
            <h1 className="text-red-500 px-2 md:px-16">Your Account will be deleted permanently</h1>
            <div className="flex">
